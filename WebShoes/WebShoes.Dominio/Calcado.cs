...
namespace WebShoes.Dominio
{
    ...
    {
        public Calcado(string _modelo, string _marca, string _cor, int _tamanho, double valor)
        {
            ...
            if (valor < 0)
                throw new BusinessException("O valor não é válido.");
        ...
        {
            return String.Format("{0} - {1} - {2} - {3}: R$ {4}", Modelo, Marca, Cor, Tamanho, Valor);
        }
    }
}
